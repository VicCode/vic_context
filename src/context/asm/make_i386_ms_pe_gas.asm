...
.text
.p2align 4,,15
.globl	_vic_make_context
.def	_vic_make_context;	.scl	2;	.type	32;	.endef
_vic_make_context:
    /* first arg of vic_make_context() == top of context-stack */
    movl  0x04(%esp), %eax
    ...
    movl  %ecx, 0x14(%eax)
    /* second arg of vic_make_context() == size of context-stack */
    movl  0x08(%esp), %edx
    ...
    /* third arg of vic_make_context() == address of context-function */
    movl  0xc(%esp), %ecx
    movl  %ecx, 0x2c(%eax)
